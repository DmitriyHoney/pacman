export class PlayerInterface {
  constructor(canvas, ctx, { obstacle, portal, coin }, color) {
    this._canvas = canvas;
    this._ctx = ctx;
    this._mapCoords = { obstacle, portal, coin };
...
//   }
//   initHunterMoving() {
//     const moveKeys = [ 'ArrowDown', 'ArrowUp', 'ArrowRight', 'ArrowLeft' ];
//     const idx = Math.floor(Math.random() * 4);
//     this.keyDownHandler({ code: moveKeys[idx] });
//   }
//   initHandleClickEvents() {
//     document.addEventListener('keydown', this.keyDownHandler.bind(this), false);
//   }
